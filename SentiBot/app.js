...
if (!keyPath) {
  console.log(
    "You need to specify a path to a service account keypair in environment variable DF_SERVICE_ACCOUNT_PATH."
  );
  process.exit(1);
}
...
if (!projectId) {
  console.log(
    "You need to specify a project ID in the environment variable DF_PROJECT_ID."
  );
  process.exit(1);
}
